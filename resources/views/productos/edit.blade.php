...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item"><a href="{{ route('productos.show', $producto) }}">{{ $producto->nombre }}</a></li>
        ...
        <div class="col-md-8">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-select @error('tipo_medicion') is-invalid @enderror" id="tipo_medicion"
                                    ...
                                    <option value="PESO"
                                        {{ old('tipo_medicion', $producto->tipo_medicion) == 'PESO' ? 'selected' : '' }}>
                                        PESO (solo kilogramos)
                                    </option>
                                    <option value="CANTIDAD"
                                        {{ old('tipo_medicion', $producto->tipo_medicion) == 'CANTIDAD' ? 'selected' : '' }}>
                                        CANTIDAD (solo unidades)
                                    </option>
                                    <option value="MIXTO"
                                        {{ old('tipo_medicion', $producto->tipo_medicion) == 'MIXTO' ? 'selected' : '' }}>
                            ...
                            <div class="col-md-4 mb-3" id="unidad-primaria-group">
                                ...
                                <input type="text" class="form-control @error('unidad_primaria') is-invalid @enderror"
                                    id="unidad_primaria" name="unidad_primaria"
                                    value="{{ old('unidad_primaria', $producto->unidad_primaria) }}" maxlength="20"
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control @error('unidad_secundaria') is-invalid @enderror"
                                    id="unidad_secundaria" name="unidad_secundaria"
                                    value="{{ old('unidad_secundaria', $producto->unidad_secundaria) }}" required
                                    maxlength="20" placeholder="Ej: kg, litros, unidades">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control @error('dias_vencimiento') is-invalid @enderror"
                                    ...
                                    value="{{ old('dias_vencimiento', $producto->dias_vencimiento) }}" required
                                    min="1" max="3650">
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-check form-switch mt-4">
                                    <input class="form-check-input @error('requiere_temperatura') is-invalid @enderror"
                                        ...
                                        value="1"
                                        {{ old('requiere_temperatura', $producto->requiere_temperatura) ? 'checked' : '' }}>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-check form-switch">
                                    ...
                                    <label class="form-check-label" for="activo">
                                        <span
                                            id="activo-text">{{ old('activo', $producto->activo) ? 'Activo' : 'Inactivo' }}</span>
                                    </label>
                                    @error('activo')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
            ...
            @if ($producto->introduccionProductos()->exists() || $producto->redespachoProductos()->exists())
                <div class="alert alert-warning mt-4" role="alert">
                    ...
                    <strong>Advertencia:</strong> Este producto tiene movimientos registrados.
                    Los cambios en las unidades de medición pueden afectar los cálculos existentes.
                </div>
            @endif
        </div>
    </div>
